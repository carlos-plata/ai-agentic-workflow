# Agentic workflow implementation for technical project management
from workflow_agents.base_agents import ActionPlanningAgent, KnowledgeAugmentedPromptAgent, EvaluationAgent, RoutingAgent

import os
from dotenv import load_dotenv

# Setup - Load API key and product specification
load_dotenv()
...
agents = [
    ...
    },
    {
        ...
        "description": "Responsible for defining product features by grouping related user stories. Creates feature specifications and identifies capabilities",
        "func": lambda x: program_manager_support_function(x)
    },
    {
        "name": "Development Engineer",
        "description": "Responsible for defining engineering tasks and technical implementation details. Creates development tasks for user stories",
