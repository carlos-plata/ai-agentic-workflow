# Agent classes for agentic workflow implementation
...
class DirectPromptAgent:
    # Directly relays prompts to LLM without additional context
...
class AugmentedPromptAgent:
    # Responds with a predefined persona
...
class KnowledgeAugmentedPromptAgent:
    # Uses specific knowledge with persona to respond
...
class EvaluationAgent:
    # Evaluates worker agent responses against criteria iteratively
...
class RoutingAgent:
    # Routes prompts to appropriate agents based on semantic similarity
    ...
    def route(self, user_input):
        ...
        # Find best matching agent based on cosine similarity
...
class ActionPlanningAgent:
    # Extracts action steps from prompts using provided knowledge
